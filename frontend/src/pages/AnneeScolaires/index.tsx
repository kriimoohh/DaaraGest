      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500">Aucune année scolaire. Commencez par en créer une.</p>
          </div>
        ) : (
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
              {annees.map((a) => (
                <tr key={a.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                  <td className="px-4 py-3 font-medium text-gray-900 dark:text-white">{a.libelle}</td>
                  <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">{fmt(a.date_debut)}</td>
                  <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">{fmt(a.date_fin)}</td>
