                  ...
                  <tr key={ev.id}>
                    ...
                    <td>
                      <div className="row" style={{ gap: 6, justifyContent: 'flex-end' }}>
                        {canEdit && (
                          <button className="tb-btn" onClick={() => openNotes(ev)} title={t('evaluation.tt_saisir_notes')} aria-label={t('evaluation.tt_saisir_notes')}>
                        ...
                        {canEdit && (
                          <button className="tb-btn" onClick={() => openEdit(ev)} title={t('evaluation.tt_modifier')} aria-label={t('evaluation.tt_modifier')}>
                            <svg width={14} height={14} viewBox="0 0 24 24" fill="currentColor">
