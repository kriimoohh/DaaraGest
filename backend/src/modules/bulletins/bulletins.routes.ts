...
import { listerHandler, genererHandler, genererAnnuelHandler, getHandler, pdfHandler, pdfClasseHandler, observationHandler, preflightHandler } from './bulletins.controller';
